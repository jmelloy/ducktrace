...
column (ids, types, timestamps, cwd/branch, model, usage, tool name/role) is
removed, as is the body text that now lives in the ``text`` column. Genuinely
un-promoted data (tool inputs, apply_patch bodies, ``stop_reason``,
